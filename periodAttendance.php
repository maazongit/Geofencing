...
<html lang="en">
    <head>        
        <!-- META SECTION -->
        <title>View Attendance Between Period - Employee Panel</title>            
             ...
             <?php include "./header.php";?>    
                ...
                <div class="page-content-wrap container">
                            <span style="padding:10px;background:#000066;color:#fff;text-align:left;font-weight:600;font-size:17px;width:100%;margin-bottom:10px;display:block;">
                                  <i class="fa fa-calendar"></i> Attendance Between Period Detail's
                            </span>
                  <div class="row"><!---row--->                         
                        <div class="col-md-12"><!---col--->    
                         ...
                         <form action="" method="post" style="margin-bottom:4px;">
                             <div class="form-inline">
                                      ...
                                      <button type="button" name="go" onclick="getEmployeeData()" class="btn btn-success"><i class="fa fa-search"></i></button>
                             </div><!---form-inline--->
                         </form><!---form--->
...
<script>
   function getEmployeeData(){
        ...
        $.ajax({
                url:"getAttendanceBetweenPeriod.php?emp_id=<?php echo $_SESSION['emp_id'];?>&start_date="+start_date+"&end_date="+end_date,
