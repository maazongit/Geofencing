...
<html lang="en">
    <head>        
        <!-- META SECTION -->
        <title>View Month Wise Attendance - Employee Panel</title>            
             ...
             <?php include "./header.php";?>    
                ...
                <div class="page-content-wrap container">
                            <span style="padding:10px;background:#000066;color:#fff;text-align:left;font-weight:600;font-size:17px;width:100%;margin-bottom:10px;display:block;">
                                  <i class="fa fa-calendar"></i> Month Wise Attendance Detail's
                            </span>
                  <div class="row"><!---row--->                         
...
<script>
   function getEmployeeData(){
        $.ajax({
                url:"getMonthWiseAttendance.php?emp_id=<?php echo $_SESSION['emp_id'];?>&month_id=<?php echo $_POST['month_id'];?>",
