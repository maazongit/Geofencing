...
<head>
    <!-- META SECTION -->
    <title>Send New Messages - Employee Panel</title>
                ...
                <div class="col-md-12">
                    ...
                    <div id="content" style="width:400px;">
                        <form action="" method="post">
                            <select name="admin_id" id="admin_id" class="form-control" required autofocus>
                                <option value="">Select Admin</option>
                                <?php
                                include "./db.php";
                                $sql = "SELECT id,name from admin WHERE status='Active'";
                        ...
                        if (isset($_POST["send"])) {
                            ...
                            $sql = "INSERT INTO messages(emp_id,admin_id,message,messageStatus)
                                                    VALUES('$emp_id','$admin_id','$message','Received')";
                            $result = $conn->query($sql);
                            if ($result === TRUE) {
                        ?>
                                <script>
