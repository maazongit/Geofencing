    ...
    <table id="myTable" class=" table table-bordered">
        ...
        <tbody>
            ...
            <div class="alert alert-info">
                <p> <b>Employee ID: </b> <?php echo $_GET["emp_id"]; ?></p>
                <p> <b>Working Time In Minute: </b> <?php echo $total_work_time_minute . " Min"; ?></p>
                <p> <b>Working Time In Hour: </b> <?php echo round($total_work_time_minute / 60, 2); ?> Hour</p>
            </div>
        </tbody>
    </table>
    <!--table end-->
